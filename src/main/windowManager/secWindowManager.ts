...
let secondaryWindow: Electron.BrowserWindow | undefined;
let secondaryWindowCreated: Promise<Electron.BrowserWindow> | undefined;
let resolveSecWindowCreate: ((value: Electron.BrowserWindow) => void) | undefined;
...
export async function showSecWindow() {
  ...
  if (!win) {
    throw new Error('Secondary window was not created');
  }
